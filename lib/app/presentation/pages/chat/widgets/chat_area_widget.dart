...
class ChatAreaWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   future: _chatController.loadMessages(_homeController.selectedConversationId.value),
  ...
  Widget buildMessageBubble(MessageEntity message, bool isUserMessage, BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: message.content != null && message.content!.startsWith('http')
